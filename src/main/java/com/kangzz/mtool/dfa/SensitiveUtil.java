...
import com.kangzz.mtool.util.ThreadUtil;
...
public class SensitiveUtil {
	...
	public static boolean containsSensitive(Object obj){
		return sensitiveTree.isMatch(JSONObject.toJSONString(obj));
	}
	...
	public static String getFindedFirstSensitive(Object obj){
		return sensitiveTree.match(JSONObject.toJSONString(obj));
	}
	...
	public static List<String> getFindedAllSensitive(Object bean){
		return sensitiveTree.matchAll(JSONObject.toJSONString(bean));
	}
	...
	public static List<String> getFindedAllSensitive(Object bean, boolean isDensityMatch, boolean isGreedMatch){
		return getFindedAllSensitive(JSONObject.toJSONString(bean), isDensityMatch, isGreedMatch);
	}
}
